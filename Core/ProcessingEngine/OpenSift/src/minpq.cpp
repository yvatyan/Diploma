...
struct min_pq* minpq_init()
{
  ...
  min_pq = static_cast<struct min_pq*>(malloc( sizeof( struct min_pq ) ));
  min_pq->pq_array = static_cast<struct pq_node*>(calloc( MINPQ_INIT_NALLOCD, sizeof( struct pq_node ) ));
